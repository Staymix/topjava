...
public abstract class JdbcMealRepository<T> implements MealRepository {
    ...
    public static class HsqlMealRepository extends JdbcMealRepository<Timestamp> {
    ...
    public static class PostgresMealRepository extends JdbcMealRepository<LocalDateTime> {
